...
function mCallback(mutations) {document.getElementById("submitted").value = window.localStorage.getItem("noteSeq");
  document.getElementById("submitted").value = window.localStorage.getItem("noteSeq");
  for (let mutation of mutations) {
      if (Object.keys(mutation.target.dataset).length > 0 && mutation.target.className.includes("active")) {
          if (window.localStorage.getItem("noteSeq") == null) {
              window.localStorage.setItem("noteSeq", mutation.target.dataset.note.concat(" "));
          }
          else {
              window.localStorage.setItem("noteSeq", window.localStorage.getItem("noteSeq").concat(mutation.target.dataset.note.concat(" ")));
              // console.log(window.localStorage.getItem("noteSeq"));
          }
      }
  }
}
...
var rangeslider0 = document.getElementById("thres_note_selected_right");
var output0 = document.getElementById("demo0");
output0.innerHTML = rangeslider0.value;
rangeslider0.oninput = function() {
  output0.innerHTML = this.value;
}

var rangeslider1 = document.getElementById("thres_note_selected_left");
...
var rangeslider2 = document.getElementById("thres_hold_selected_right");
...
var rangeslider3 = document.getElementById("thres_hold_selected_left");
...
var rangeslider4 = document.getElementById("seq_len_selected");
...
var rangeslider5 = document.getElementById("n_steps_selected");
...
var rangeslider6 = document.getElementById("tempo_selected");
...
document.getElementById("mywav").load()
